...
public class Student_Course extends JFrame implements ActionListener {
    ...
    String st_id = "",st_name="",st_class="";

    String[] columnNames = { "s_id", "s_name", "s_class" };
    String[] SC_columns = {"st_id","st_name","st_class"};
    JFrame frm,frmdisp;
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            if (ae.getSource() == Search) {
                String s1 = JOptionPane.showInputDialog(null, "Enter Student Id");

                pstmt = con.prepareStatement("select * from student1 where s_id=?");
            ...
            if (ae.getSource() == Delete) {
                String s1 = JOptionPane.showInputDialog(null, "Enter Student Id ");
                pstmt = con.prepareStatement("delete from student1 where s_id=?");
            ...
            if (ae.getSource() == course) {
                ...
                String s1 = JOptionPane.showInputDialog(null, "Enter course Id");
                ...
                pstmt = con.prepareStatement("select sc.s_id ,s_name,s_class from sc,student1,course where student1.s_id=sc.s_id and  course.c_id=sc.c_id and sc.c_id=?");



              //  pstmt=con.prepareStatement("select s_id from sc where c_id=?");
                ...
                while (rs.next()) {
                  st_id = rs.getString(1);
                   ...
                   st_class = rs.getString(3);
               
                    


                    // This all coloumn names are taken from sc table.
                    model.addRow(new Object[] {st_id,st_name,st_class}  );
...
class AddStudent extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:postgresql://localhost/postgres", "postgres", "sakshi");
